...
public class HealthBar : MonoBehaviour {
	...
	//public float MAXIMUM = 1f; // Maximum value of health possible
	...
	void Update() {
		...
		//}
		//Debug.Log (length);
		rectTransform.sizeDelta = new Vector2(240 * heroMovement.health / heroMovement.MAX_HEALTH,
		                                      10);
		...
		rectTransform.position = new Vector3(80 + rectTransform.rect.width / 2,
		                                     Screen.height - 20 - rectTransform.rect.height / 2,
		                                     0);
	}
}
